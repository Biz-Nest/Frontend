  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 header">
      <div className="container flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <div onClick={toggleThemeHandler} className="dark-toggle-parent">
            <div id="dark-toggle">
              <i class="fa-regular fa-sun dark:text-white active" id="sun"></i>
              <i class="fa-regular fa-moon dark:text-white" id="moon"></i>
            </div>
          </div>
