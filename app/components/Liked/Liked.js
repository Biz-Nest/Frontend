  ...
  useEffect(() => {
    const fetchLikes = async () => {
      ...
      try {
        ...
        const marketGabLikes = data.filter(
          (like) => like.content_type === 11 && like.user === userId
        );
        const ideaLikes = data.filter(
          (like) => like.content_type === 9 && like.user === userId
        );
            ...
            ideaLike.map((like) => (
              ...
              >
                ...
                <div className="info">
                  <p>
                    <strong>Title:</strong>{" "}
                    {like.content_object?.name || "Unknown Name"}
                  </p>
                  <p>
                    <strong>Category:</strong>{" "}
                    {like.content_object?.category || "Unknown Category"}
                  </p>
                  <p>
                  ...
                  <span
                    onClick={() =>
                      handleDetailsClickIdea(like.content_object?.id)
                    }
                  >
            ...
            marketGabLike.map((like) => (
              ...
              >
                ...
                <div className="info">
                  ...
                  <span
                    onClick={() => handleDetailsClick(like.content_object.id)}
                  >
                    More Details <i className="ri-arrow-right-line"></i>
                  </span>
                </div>
