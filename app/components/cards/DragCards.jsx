    ...
    return (
        <section className="relative grid min-h-screen w-full place-content-center overflow-hidden bg-neutral-950">
            <h2 className="relative z-0 text-[20vw] font-black text-neutral-800 md:text-[200px]">
                ASaad<span className="text-indigo-500">.</span>
            </h2>
            <Cards />
        </section>
    );
    ...
    return (
      ...
      /> */}
            <Card
                ...
                className="w-24 md:w-48"
            >
                {/* Additional elements rendered alongside the image */}
                <div className="p-4 border rounded-lg shadow">
                    <p><strong>Name:</strong> arstarst</p>
                    <p><strong>id field for test:</strong> arstarst</p>
                    <p><strong>Description:</strong> rstrast</p>
                    <p><strong>Category:</strong> arstrst</p>
                    <p><strong>Owner:</strong> arstrt</p>
                    <p><strong>Cost:</strong> rast</p>
                    <p><strong>Location:</strong> arst</p>
                    <p><strong>Expenses:</strong> arst</p>
                    <p><strong>Date:</strong> arst</p>
                </div>
            </Card>
...
const Card = ({ containerRef, src, alt, top, left, rotate, className, children }) => {
    ...
    return (
      <motion.div
        ...
        className={twMerge(
          "drag-elements absolute p-1 pb-4 bg-neutral-200",
          className
        )}
        drag
